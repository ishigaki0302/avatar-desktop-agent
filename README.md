...
ローカル LLM（Ollama / granite4:3b）で会話しつつ、OpenClaw をデスクトップ操作エンジンとして使い、
...
- Node.js 22+
- pnpm 9+
- [Ollama](https://ollama.com/) インストール済み・`granite4:3b` pull 済み
...
```jsonl
{"type":"session_start","session_id":"2026-03-01_21-00-00_abc123","started_at":"...","model":"granite4:3b","max_predict_tokens":150,"system_prompt_hash":"97febf0f"}
...
| Phase 5 | granite4:3b + アリスプロンプト設計 | ✅ |
